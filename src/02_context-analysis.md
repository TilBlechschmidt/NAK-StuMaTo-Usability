...
Studentenbetreuer hat das Interesse, dass die Ausbildung der Studenten breit angelegt ist (B1). Der Student soll möglichst viele Rollen (Tester, Entwickler, Konzeption) während sein Studiums eingenommen haben (B1). Dabei kann der Student sich zwar wünschen, was er in seiner nächsten Praxisphase machen möchte, jedoch entscheidet am Ende der Betreuer (B1). Deswegen wird der Einfluss des Studentenbetreuers auf Hoch eingeschätzt. Im Interview kam heraus, dass das Programm StuMaTo vom Studentenbetreuer gerne benutzt wird und vor allem als Sammeltopf für externe Aufgaben dient und die Aufgaben so den Studenten zugeordnet werden (B1).
